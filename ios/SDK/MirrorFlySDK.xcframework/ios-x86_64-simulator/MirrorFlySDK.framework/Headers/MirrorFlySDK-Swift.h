...
/// if 0 every one can message. if 1 admin only can message
@property (nonatomic) NSInteger messageMode;
/// if 0 group is private. if 1 group is public
@property (nonatomic) NSInteger accessMode;
/// To view the history messages for the channel
@property (nonatomic) NSInteger history;
@property (nonatomic, copy) NSString * _Nonnull groupDescription;
@property (nonatomic, copy) NSString * _Nonnull customFeatures;
@property (nonatomic) NSInteger channelStatus;
@property (nonatomic, copy) NSString * _Nonnull inviteURI;
...
/// To handle channel status from push
...
/// Singleton configuration manager for setting up and accessing MFChannel
SWIFT_CLASS("_TtC12MirrorFlySDK22MFChannelConfiguration")
@interface MFChannelConfiguration : NSObject
...
SWIFT_ENUM_FWD_DECL(NSInteger, MessageStatus)
...
/// syncedName of the user
@property (nonatomic, copy) NSString * _Nonnull syncedContactName;
...
/// Pass Value as 1 for ADMIN only can message (Announsement), Default 0 (Every one Can message)
@property (nonatomic) NSInteger messageMode;
/// Default it will 0 (private) IF need of public pass value as  1
@property (nonatomic) NSInteger accessMode;
/// To view the history messages for the channel
@property (nonatomic) NSInteger history;
/// Group description, if chat type is group
@property (nonatomic, copy) NSString * _Nonnull groupDescription;
/// key and value if need of any additional features for the channel (group)
@property (nonatomic, copy) NSString * _Nonnull customFeatures;
/// To find channel is enabled or disabled or deleted
@property (nonatomic) NSInteger channelStatus;
/// To group
@property (nonatomic, copy) NSString * _Nonnull inviteURI;
- (nonnull instancetype)initWithJid:(NSString * _Nonnull)jid OBJC_DESIGNATED_INITIALIZER;
...
/// last Sent Message as ChatMessage
@property (nonatomic, strong) ChatMessage * _Nullable lastSentMessage;
