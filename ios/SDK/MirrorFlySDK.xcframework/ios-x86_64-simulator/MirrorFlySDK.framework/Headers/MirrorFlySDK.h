...
//! Project version number for MirrorFlySDK.
FOUNDATION_EXPORT double MirrorFlySDKVersionNumber;

//! Project version string for MirrorFlySDK.
FOUNDATION_EXPORT const unsigned char MirrorFlySDKVersionString[];
