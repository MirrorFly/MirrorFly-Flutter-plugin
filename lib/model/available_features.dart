...
class AvailableFeatures {
  ...
  /*AvailableFeaturesModel(isGroupChatEnabled: true, isGroupCallEnabled: true, isOneToOneCallEnabled: true,
  isRecentChatSearchEnabled: true, isImageAttachmentEnabled: true, isVideoAttachmentEnabled: true, isAudioAttachmentEnabled: true,
   isDocumentAttachmentEnabled: true, isContactAttachmentEnabled: true, isLocationAttachmentEnabled: true, isAttachmentEnabled: true,
    isStarMessageEnabled: true, isClearChatEnabled: true, isDeleteChatEnabled: true, isTranslationEnabled: true, isBlockEnabled: true,
    isReportEnabled: true, isDeleteMessageEnabled: true, isViewAllMediasEnabled: true, isChatHistoryEnabled: true)*/
  factory AvailableFeatures.fromJson(Map<String, dynamic> json) => AvailableFeatures(
    ...
    isViewAllMediaAvailable: Platform.isIOS ? json["isViewAllMediasEnabled"] : json["isViewAllMediaEnabled"],
