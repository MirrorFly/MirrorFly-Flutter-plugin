...
class ExportModel {
  ...
  factory ExportModel.fromJson(Map<String, dynamic> json) => ExportModel(
    ...
    mediaAttachmentsUrl: json["mediaAttachmentsUrl"] == null ? [] : List<String>.from(json["mediaAttachmentsUrl"]!.map((x) => x)),
  );

  Map<String, dynamic> toJson() => {
    "subject": subject,
    "messageContent": messageContent,
    "mediaAttachmentsUrl": mediaAttachmentsUrl == null ? [] : List<dynamic>.from(mediaAttachmentsUrl!.map((x) => x)),
  };
}
