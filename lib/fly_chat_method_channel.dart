...
class MethodChannelFlyChatFlutter extends FlyChatFlutterPlatform {
  ...
  addStreamsAllToStreamController() {
    _messageOnReceivedStreamController
        .addStream(messageOnReceivedChannel.receiveBroadcastStream());
    messageStatusUpdateStreamController
        .addStream(messageStatusUpdatedChanel.receiveBroadcastStream());
    mediaStatusUpdatedStreamController
        .addStream(mediaStatusUpdatedChannel.receiveBroadcastStream());
    uploadDownloadProgressChangedStreamController.addStream(
        uploadDownloadProgressChangedChannel.receiveBroadcastStream());
    showUpdateCancelNotificationStreamController.addStream(
        showUpdateCancelNotificationChannel.receiveBroadcastStream());
    onGroupProfileFetchedStreamController.addStream(onGroupProfileFetchedChannel
        .receiveBroadcastStream() /*as Stream<String>*/);
    onNewGroupCreatedStreamController.addStream(onNewGroupCreatedChannel
        .receiveBroadcastStream() /*as Stream<String>*/);
    onGroupProfileUpdatedStreamController.addStream(onGroupProfileUpdatedChannel
        .receiveBroadcastStream() /*as Stream<String>*/);
    onNewMemberAddedToGroupStreamController
        .addStream(onNewMemberAddedToGroupChannel.receiveBroadcastStream());
    onMemberRemovedFromGroupStreamController
        .addStream(onMemberRemovedFromGroupChannel.receiveBroadcastStream());
    onFetchingGroupMembersCompletedStreamController.addStream(
        onFetchingGroupMembersCompletedChannel
            .receiveBroadcastStream() /*as Stream<String>*/);
    onDeleteGroupStreamController
        .addStream(onDeleteGroupChannel.receiveBroadcastStream());
    onFetchingGroupListCompletedStreamController.addStream(
        onFetchingGroupListCompletedChannel.receiveBroadcastStream());
    onMemberMadeAsAdminStreamController
        .addStream(onMemberMadeAsAdminChannel.receiveBroadcastStream());
    onMemberRemovedAsAdminStreamController
        .addStream(onMemberRemovedAsAdminChannel.receiveBroadcastStream());
    onLeftFromGroupStreamController
    ...
    blockedThisUserStreamController
        .addStream(blockedThisUserChannel.receiveBroadcastStream());
    myProfileUpdatedStreamController.addStream(
        myProfileUpdatedChannel.receiveBroadcastStream() /*as Stream<bool>*/);
    onAdminBlockedOtherUserStreamController
        .addStream(onAdminBlockedOtherUserChannel.receiveBroadcastStream());
    onAdminBlockedUserStreamController
        .addStream(onAdminBlockedUserChannel.receiveBroadcastStream());
    onContactSyncCompleteStreamController.addStream(onContactSyncCompleteChannel
        .receiveBroadcastStream() /*as Stream<bool>*/);
    onLoggedOutStreamController.addStream(
        onLoggedOutChannel.receiveBroadcastStream() /*as Stream<bool>*/);
    unblockedThisUserStreamController
        .addStream(unblockedThisUserChannel.receiveBroadcastStream());
    userBlockedMeStreamController
        .addStream(userBlockedMeChannel.receiveBroadcastStream());
    userCameOnlineStreamController
        .addStream(userCameOnlineChannel.receiveBroadcastStream());
    userDeletedHisProfileStreamController.addStream(userDeletedHisProfileChannel
        .receiveBroadcastStream() /*as Stream<String>*/);
    userProfileFetchedStreamController
        .addStream(userProfileFetchedChannel.receiveBroadcastStream());
    userUnBlockedMeStreamController
        .addStream(userUnBlockedMeChannel.receiveBroadcastStream());
    userUpdatedHisProfileStreamController
        .addStream(userUpdatedHisProfileChannel.receiveBroadcastStream());
    userWentOfflineStreamController
        .addStream(userWentOfflineChannel.receiveBroadcastStream());
    usersIBlockedListFetchedStreamController
        .addStream(usersIBlockedListFetchedChannel.receiveBroadcastStream());
    usersProfilesFetchedStreamController.addStream(usersProfilesFetchedChannel
        .receiveBroadcastStream() /*as Stream<bool>*/);
    usersWhoBlockedMeListFetchedStreamController.addStream(
        usersWhoBlockedMeListFetchedChannel.receiveBroadcastStream());
    onConnectedStreamController
        .addStream(onConnectedChannel.receiveBroadcastStream());
    onDisconnectedStreamController
        .addStream(onDisconnectedChannel.receiveBroadcastStream());
    onConnectionFailedStreamController
        .addStream(onConnectionFailedChannel.receiveBroadcastStream());
    connectionFailedStreamController
        .addStream(connectionFailedChannel.receiveBroadcastStream());
    connectionSuccessStreamController
        .addStream(connectionSuccessChannel.receiveBroadcastStream());
    onWebChatPasswordChangedStreamController
        .addStream(onWebChatPasswordChangedChannel.receiveBroadcastStream());
    setTypingStatusStreamController
        .addStream(setTypingStatusChannel.receiveBroadcastStream());
    onChatTypingStatusStreamController
        .addStream(onChatTypingStatusChannel.receiveBroadcastStream());
    onGroupTypingStatusStreamController
        .addStream(onGroupTypingStatusChannel.receiveBroadcastStream());
    onFailureStreamController
        .addStream(onFailureChannel.receiveBroadcastStream());
    onProgressChangedStreamController
        .addStream(onProgressChangedChannel.receiveBroadcastStream());
    onSuccessStreamController
        .addStream(onSuccessChannel.receiveBroadcastStream());
    // onCallReceivingStreamController.addStream(onCallReceivingChannel.receiveBroadcastStream());
    onLocalVideoTrackAddedStreamController
        .addStream(onLocalVideoTrackAddedChannel.receiveBroadcastStream());
    onRemoteVideoTrackAddedStreamController
        .addStream(onRemoteVideoTrackAddedChannel.receiveBroadcastStream());
    onTrackAddedStreamController
        .addStream(onTrackAddedChannel.receiveBroadcastStream());
    onCallStatusUpdatedStreamController
        .addStream(onCallStatusUpdatedChannel.receiveBroadcastStream());
    onCallActionStreamController
        .addStream(onCallActionChannel.receiveBroadcastStream());
    onMuteStatusUpdatedStreamController
        .addStream(onMuteStatusUpdatedChannel.receiveBroadcastStream());
    onUserSpeakingStreamController
  ...
  Future<dynamic> registerUser(String userIdentifier,
    ...
    try {
      registerResponse = await mirrorFlyMethodChannel.invokeMethod(
          'register_user',
          {"userIdentifier": userIdentifier, "token": fcmToken});
 ...
 Future<dynamic> reportChatOrUser(String jid, String chatType, String? messageId) async {
  ...
  Future<dynamic> getGroupMessageDeliveredToList(
    ...
    try {
      ...
      LogMessage.d("getGroupMessageDeliveredToList Response ",
          " $messageDeleteResponse");
      return messageDeleteResponse;
    } on PlatformException catch (e) {
      LogMessage.d("Platform Exception =", " $e");
  ...
  Future<String?> createTopic(
    ...
    try {
      val = await mirrorFlyMethodChannel.invokeMethod(
