...
class MethodChannelFlyChatFlutter extends FlyChatFlutterPlatform {
  ...
  Future<dynamic> registerUser(String userIdentifier, {String fcmToken = ""}) async {
    ...
    try {
      registerResponse = await mirrorFlyMethodChannel
          .invokeMethod('register_user', {"userIdentifier": userIdentifier, "token": fcmToken});
  ...
  @override
  Future<dynamic> sendTextMessage(String message, String jid, String replyMessageId, {String? topicId}) async {
    dynamic messageResp;
    try {
...
@override
 Future<dynamic> listenGroupChatEvents() async {
  ...
  @override
  Future<dynamic> sendContactMessage(List<String> contactList, String jid, String contactName, String replyMessageId,
      {String? topicId}) async {
  ...
  Future<dynamic> clearChat(String jid, String chatType, bool clearExceptStarred) async {
    ...
    try {
      clearChatResponse = await mirrorFlyMethodChannel
          .invokeMethod('clear_chat', {"jid": jid, "chat_type": chatType, "clear_except_starred": clearExceptStarred});
...
@override
 Future<dynamic> reportChatOrUser(String jid, String chatType, String? messageId) async {
  ...
  @override
  Future<dynamic> deleteMessagesForMe(String jid, String chatType, List<String> messageIds, bool? isMediaDelete) async {
    dynamic messageDeleteResponse;
    try {
      messageDeleteResponse = await mirrorFlyMethodChannel.invokeMethod('deleteMessagesForMe',
  ...
  @override
  Future<dynamic> deleteMessagesForEveryone(
      String jid, String chatType, List<String> messageIds, bool? isMediaDelete) async {
    dynamic messageDeleteResponse;
    try {
      messageDeleteResponse = await mirrorFlyMethodChannel.invokeMethod('deleteMessagesForEveryone',
          {"jid": jid, "chat_type": chatType, "isMediaDelete": isMediaDelete, "message_ids": messageIds});
  ...
  Future<dynamic> deleteMessages(String jid, List<String> messageIds, bool isDeleteForEveryOne) async {
    dynamic messageDeleteResponse;
    try {
      messageDeleteResponse = await mirrorFlyMethodChannel.invokeMethod('delete_messages',
          {"jid": jid, "chat_type": "chat", "message_ids": messageIds, "is_delete_for_everyone": isDeleteForEveryOne});
  ...
  Future<dynamic> getGroupMessageDeliveredToList(String messageId, String jid) async {
    ...
    try {
      ...
      LogMessage.d("getGroupMessageDeliveredToList Response ", " $messageDeleteResponse");
      return messageDeleteResponse;
    } on PlatformException catch (e) {
      LogMessage.d("Platform Exception =", " $e");
      rethrow;
  ...
  Future<dynamic> forwardMessagesToMultipleUsers(List<String> messageIds, List<String> userList) async {
    ...
    try {
      forwardMessageResponse = await mirrorFlyMethodChannel
          .invokeMethod('forwardMessagesToMultipleUsers', {"message_ids": messageIds, "userList": userList});
  ...
  Future<dynamic> forwardMessages(List<String> messageIds, String tojid, String chattype) async {
    ...
    try {
      forwardMessageResponse = await mirrorFlyMethodChannel
          .invokeMethod('forwardMessages', {"message_ids": messageIds, "to_jid": tojid, "chat_type": chattype});
  ...
  Future<dynamic> deleteAccount(String reason, String? feedback) async {
    ...
    try {
      response = await mirrorFlyMethodChannel
          .invokeMethod('delete_account', {"delete_reason": reason, "delete_feedback": feedback});
      return response;
    } on PlatformException catch (e) {
      LogMessage.d("Platform Exception =", " $e");
      rethrow;
